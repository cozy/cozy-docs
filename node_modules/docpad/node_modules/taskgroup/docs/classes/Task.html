...
Examples
 ...
 task = require('taskgroup').Task.create('my task that errors', function(){
  ...
  <div class='examples'>
    ...
    <pre><code class='coffee'>task = require(&#39;taskgroup&#39;).Task.create(&#39;my synchronous task&#39;, function(){
  return 5
}).done(console.log)  &#47;&#47; [null, 5]</code></pre>
    <h4>
      
    </h4>
    <pre><code class='coffee'>task = require(&#39;taskgroup&#39;).Task.create(&#39;my asynchronous task&#39;, function(complete){
  complete(null, 5)
}).done(console.log)  &#47;&#47; [null, 5]</code></pre>
    <h4>
      
    </h4>
    <pre><code class='coffee'>task = require(&#39;taskgroup&#39;).Task.create(&#39;my task that errors&#39;, function(){
  var err = new Error(&#39;deliberate error&#39;)
  return err;  &#47;&#47; if asynchronous, can also do: complete(err)
  &#47;&#47; thrown and uncaught errors are also caught thanks to domains, but that should be avoided
  &#47;&#47; as it would put your app in an unknown state
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='isTask-class'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.4
/src&#47;lib&#47;taskgroup.coffee#L157'>Source</a>
    </p>
    <div class='docstring'>
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='constructor-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.4
/src&#47;lib&#47;taskgroup.coffee#L188'>Source</a>
    </p>
    <div class='docstring'>
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='destroy-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.4
/src&#47;lib&#47;taskgroup.coffee#L354'>Source</a>
    </p>
    <div class='docstring'>
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='hasExited-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.4
/src&#47;lib&#47;taskgroup.coffee#L268'>Source</a>
    </p>
    <div class='docstring'>
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='hasStarted-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.4
/src&#47;lib&#47;taskgroup.coffee#L262'>Source</a>
    </p>
    <div class='docstring'>
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='isComplete-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.4
/src&#47;lib&#47;taskgroup.coffee#L280'>Source</a>
    </p>
    <div class='docstring'>
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='isDestroyed-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.4
/src&#47;lib&#47;taskgroup.coffee#L274'>Source</a>
    </p>
    <div class='docstring'>
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='onceDone-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.4
/src&#47;lib&#47;taskgroup.coffee#L338'>Source</a>
    </p>
    <div class='docstring'>
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='run-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.4
/src&#47;lib&#47;taskgroup.coffee#L424'>Source</a>
    </p>
    <div class='docstring'>
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='setConfig-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.4
/src&#47;lib&#47;taskgroup.coffee#L221'>Source</a>
    </p>
    <div class='docstring'>
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='whenDone-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.4
/src&#47;lib&#47;taskgroup.coffee#L326'>Source</a>
    </p>
    <div class='docstring'>
