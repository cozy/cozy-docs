...
You can see the documentation being served on: http://localhost:9778/. Do not be irritated if you see only a plain text page welcoming you, append the appropriate path for the page you would like to see, in example: http://localhost:9778/hack/getting-started/
