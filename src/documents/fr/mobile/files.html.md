...
* téléchargez le [fichier APK](https://files.cozycloud.cc/android/CozyMobile_lastest.apk) (la dernière version de l’application est la v0.2.1, dont le sha1 est : 6cd69f732b4d1ce707cce2789a67f5802a96bc5e)
