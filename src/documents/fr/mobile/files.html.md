...
* téléchargez le [fichier APK](https://files.cozycloud.cc/android/CozyMobile_lastest.apk) (la dernière version de l’application est la v1.4.0, dont le sha1 est : b0caf993e8ba7897fcde05b7baa91d3ccbb07bfb)
